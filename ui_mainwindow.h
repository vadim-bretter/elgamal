...
**
** Created: Wed 20. Nov 16:52:33 2013
...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        lineEdit_M->setInputMethodHints(Qt::ImhNone);
        ...
        formLayout->setWidget(14, QFormLayout::FieldRole, lineEdit);

        verticalSpacer_3 = new QSpacerItem(20, 40, QSizePolicy::Minimum, QSizePolicy::Expanding);

        formLayout->setItem(13, QFormLayout::FieldRole, verticalSpacer_3);

        v1_2 = new QLineEdit(formLayoutWidget);
        v1_2->setObjectName(QString::fromUtf8("v1_2"));

        formLayout->setWidget(10, QFormLayout::FieldRole, v1_2);

        v2 = new QLineEdit(formLayoutWidget);
        v2->setObjectName(QString::fromUtf8("v2"));

        formLayout->setWidget(12, QFormLayout::FieldRole, v2);

        v1 = new QLabel(formLayoutWidget);
        v1->setObjectName(QString::fromUtf8("v1"));

        formLayout->setWidget(9, QFormLayout::FieldRole, v1);

        label_11 = new QLabel(formLayoutWidget);
        label_11->setObjectName(QString::fromUtf8("label_11"));

        formLayout->setWidget(11, QFormLayout::FieldRole, label_11);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        v1->setText(QApplication::translate("MainWindow", "\320\240\320\265\320\267\321\203\320\273\321\214\321\202\320\260\321\202 V1", 0, QApplication::UnicodeUTF8));
        label_11->setText(QApplication::translate("MainWindow", "\320\240\320\265\320\267\321\203\320\273\321\214\321\202\320\260\321\202 V2", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
